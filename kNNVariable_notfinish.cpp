...
std::vector<Point> TestQuery(std::string fileName, int maxNumEvts, int IntensityType){
  ...
  // Change the values of k that you want. Here, I choose k = [60; 140; 10]
  std::cout << "\t" << "Producing roID with k = [60; 140; 10]..." << std::endl;
  for(int i = 0; i < testPoints.size(); i++) { testPoints[i].dungpid_60 = GetPID(testPoints, i, 60, IntensityType); }
  std::cout << "\t \t" << "- Done with k = 60." << std::endl;
  for(int i = 0; i < testPoints.size(); i++) { testPoints[i].dungpid_70 = GetPID(testPoints, i, 70, IntensityType); }
  std::cout << "\t \t" << "- Done with k = 70." << std::endl;
  for(int i = 0; i < testPoints.size(); i++) { testPoints[i].dungpid_80 = GetPID(testPoints, i, 80, IntensityType); }
  std::cout << "\t \t" << "- Done with k = 80. <Standard roID>" << std::endl;
  for(int i = 0; i < testPoints.size(); i++) { testPoints[i].dungpid_90 = GetPID(testPoints, i, 90, IntensityType); }
  std::cout << "\t \t" << "- Done with k = 90." << std::endl;
  for(int i = 0; i < testPoints.size(); i++) { testPoints[i].dungpid_100 = GetPID(testPoints, i, 100, IntensityType); }
  std::cout << "\t \t" << "- Done with k = 100." << std::endl;
  for(int i = 0; i < testPoints.size(); i++) { testPoints[i].dungpid_110 = GetPID(testPoints, i, 110, IntensityType); }
  std::cout << "\t \t" << "- Done with k = 110." << std::endl;
  for(int i = 0; i < testPoints.size(); i++) { testPoints[i].dungpid_120 = GetPID(testPoints, i, 120, IntensityType); }
  std::cout << "\t \t" << "- Done with k = 120." << std::endl;
  for(int i = 0; i < testPoints.size(); i++) { testPoints[i].dungpid_130 = GetPID(testPoints, i, 130, IntensityType); }
  std::cout << "\t \t" << "- Done with k = 130." << std::endl;
  for(int i = 0; i < testPoints.size(); i++) { testPoints[i].dungpid_140 = GetPID(testPoints, i, 140, IntensityType); }
  std::cout << "\t \t" << "- Done with k = 140." << std::endl;
...
std::vector< std::vector<TH1D> > MakekNNroIDROOTFile(std::vector< std::vector<Point> > HI, std::vector< std::vector<Point> > LI, std::vector< std::vector<Point> > SI) {
  ...
  t_HI.Branch("dungpid_70", &dungpid_70,"dungpid_70/D");
  t_HI.Branch("dungpid_80", &dungpid_80,"dungpid_80/D");
  t_HI.Branch("dungpid_90", &dungpid_90,"dungpid_90/D");
  t_HI.Branch("dungpid_100", &dungpid_100,"dungpid_100/D");
  t_HI.Branch("dungpid_110", &dungpid_110,"dungpid_110/D");
  t_HI.Branch("dungpid_120", &dungpid_120,"dungpid_120/D");
  t_HI.Branch("dungpid_130", &dungpid_130,"dungpid_130/D");
  t_HI.Branch("dungpid_140", &dungpid_140,"dungpid_140/D");
  ...
  t_LI.Branch("signalMC", &signalMC,"signalMC/O");
  t_LI.Branch("dungpid_60", &dungpid_60,"dungpid_60/D");
  t_LI.Branch("dungpid_70", &dungpid_70,"dungpid_70/D");
  t_LI.Branch("dungpid_80", &dungpid_80,"dungpid_80/D");
  t_LI.Branch("dungpid_90", &dungpid_90,"dungpid_90/D");
  t_LI.Branch("dungpid_100", &dungpid_100,"dungpid_100/D");
  t_LI.Branch("dungpid_110", &dungpid_110,"dungpid_110/D");
  t_LI.Branch("dungpid_120", &dungpid_120,"dungpid_120/D");
  t_LI.Branch("dungpid_130", &dungpid_130,"dungpid_130/D");
  t_LI.Branch("dungpid_140", &dungpid_140,"dungpid_140/D");
  t_LI.Branch("knn01TrkActivePlanes", &knn01TrkActivePlanes,"knn01TrkActivePlanes/F");
  t_LI.Branch("knn10TrkMeanPh", &knn10TrkMeanPh,"knn10TrkMeanPh/F");
  t_LI.Branch("knn20LowHighPh", &knn20LowHighPh,"knn20LowHighPh/F");
  t_LI.Branch("knn40TrkPhFrac", &knn40TrkPhFrac,"knn40TrkPhFrac/F");

  t_SI.Branch("signalMC", &signalMC,"signalMC/O");
  t_SI.Branch("dungpid_60", &dungpid_60,"dungpid_60/D");
  t_SI.Branch("dungpid_70", &dungpid_70,"dungpid_70/D");
  t_SI.Branch("dungpid_80", &dungpid_80,"dungpid_80/D");
  t_SI.Branch("dungpid_90", &dungpid_90,"dungpid_90/D");
  t_SI.Branch("dungpid_100", &dungpid_100,"dungpid_100/D");
  t_SI.Branch("dungpid_110", &dungpid_110,"dungpid_110/D");
  t_SI.Branch("dungpid_120", &dungpid_120,"dungpid_120/D");
  t_SI.Branch("dungpid_130", &dungpid_130,"dungpid_130/D");
  t_SI.Branch("dungpid_140", &dungpid_140,"dungpid_140/D");
  t_SI.Branch("knn01TrkActivePlanes", &knn01TrkActivePlanes,"knn01TrkActivePlanes/F");
  t_SI.Branch("knn10TrkMeanPh", &knn10TrkMeanPh,"knn10TrkMeanPh/F");
